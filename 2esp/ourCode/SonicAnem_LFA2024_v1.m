...
filenameSonic='prove.dat'; %type in the name of the file containing the sonic data  
...
datetick('x','HH:MM');
legend('Var(u)','Var(v)','Var(w)','FontSize',20);
xlabel('time')
...
plot(Tsavg,wavg,'.r','MarkerSize',18);
ylabel('w (m/s)')
...
datetick('x','HH:MM');
legend('Ts','Orientation','horizontal','Location','bestoutside','FontSize',18);
%---------------------------------------------------------
...
datetick('x','HH:MM');
legend('Ts','Orientation','horizontal','Location','bestoutside','FontSize',20);
%---------------------------------------------------------
